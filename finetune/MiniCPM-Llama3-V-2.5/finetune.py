...
def train():
    ...
    # Format the run name
    training_args.run_name = f"run_{training_args.learning_rate}_llm_{training_args.tune_llm}_vision_{training_args.tune_vision}_lora_{training_args.use_lora}"
