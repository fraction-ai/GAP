...
s3_folder = 'checkpoints/cmp_adv/fft_2e-6/checkpoint-1000/'  # Folder to download
local_dir = '../evaluate/checkpoints/minicpm/'  # Local directory where the folder will be saved
