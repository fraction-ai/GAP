...
s3_folder = 'checkpoints/QWEN2-VL/qwen2_7B_cmp_adv/checkpoint-1400/'  # Folder to download
local_dir = '../evaluate/checkpoints/qwen2_7B/'  # Local directory where the folder will be saved
